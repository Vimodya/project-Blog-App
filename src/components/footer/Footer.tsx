    ...
    <div>
      <div className="w-full bg-gray-400 flex sm:flex-row flex-col">
        ...
        <div className="sm:w-1/4 w-full">
          <div className="flex flex-col pr-12 py-8 sm:pl-0 pl-6">
            <div className="text-[#192841] text-md font-light ">
              Leave a thought
            </div>
            <form>
              <div className="flex flex-col">
                ...
                <div className="flex flex-col space-y-4 mt-4">
                  ...
                  <div className="flex justify-end">
                    {" "}
                    <button className="bg-[#040326] text-white px-2 py-2 rounded-lg w-1/2 ">
                      Send
                    </button>
                  </div>
                </div>
